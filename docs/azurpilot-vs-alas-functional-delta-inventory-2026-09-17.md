...
## Generated configuration-key delta

Upstream keys: 326; AzurPilot keys: 777; added: 488; removed: 37; changed defaults: 7.
...
- `ActionPoint_Total`
- `ActionPoint_Value`
- `AutoEquip_EnableSlot1`
- `AutoEquip_EnableSlot2`
- `AutoEquip_EnableSlot3`
- `AutoEquip_EnableSlot4`
- `AutoEquip_EnableSlot5`
- `AutoEquip_ShipLimit`
- `Backup_Enable`
- `Backup_KeepDays`
- `BoxDisassemble_BlueBoxLimit`
- `BoxDisassemble_PurpleBoxLimit`
- `BoxDisassemble_UseBlueBox`
- `BoxDisassemble_UsePurpleBox`
- `BoxDisassemble_UseWhiteBox`
- `BoxDisassemble_WhiteBoxLimit`
- `Campaign_DefeatWithdraw`
- `Campaign_UseRecommendFleet`
- `CoalitionScuttle_Sacrifice`
- `Coin_Color`
- `Coin_Limit`
- `Coin_Record`
- `Coin_Value`
- `Commission_Blacklist`
- `Commission_CommissionNotifyReward`
- `Commission_CommissionNotifyRewardStatistics`
- `Commission_DeadlineFutureHorizon`
- `Commission_DelayHalfLife`
- `Commission_DetectShipDrop`
- `Commission_DynamicProgramming`
- `Commission_FilterValueFloor`
- `Commission_FilterValueHalfLife`
- `Commission_GemNotify`
- `Commission_GemStatistics`
- `Commission_GemStatisticsPeriod`
...
- `Cube_Value`
- `DailySummary_Enable`
- `DailySummary_TriggerTime`
- `Dorm_BuyFood`
- `DropRecord_BugReport`
- `DropRecord_CommissionIncomeScreenshot`
- `DropRecord_RetentionDays`
- `DropRecord_TelemetryReport`
- `ElectronicProcessing_Positions`
- `Emotion_Fleet1Onsen`
- `Emotion_Fleet2Onsen`
- `EmulatorInfo_EnableRemoteSSH`
- `EmulatorInfo_RemoteSSHHost`
- `EmulatorInfo_RemoteSSHPort`
- `EmulatorInfo_RemoteSSHPublicKey`
- `EmulatorInfo_RemoteSSHUser`
- `EmulatorInfo_RemoteStartCommand`
- `EmulatorInfo_RemoteStopCommand`
- `EmulatorManagement_DeepRestartAfterFailures`
- `EmulatorManagement_ForceScheduledRestart`
- `EmulatorManagement_RestartIntervalHours`
- `EmulatorManagement_ScheduledEmulatorRestart`
- `EmulatorManager_EnableRemoteSSH`
- `EmulatorManager_RemoteSSHHost`
- `EmulatorManager_RemoteSSHPort`
- `EmulatorManager_RemoteSSHPublicKey`
- `EmulatorManager_RemoteSSHUser`
- `EmulatorManager_RemoteStartCommand`
- `EmulatorManager_RemoteStopCommand`
- `Emulator_GameSettings`
- `Error_AdbOfflineRestart`
- `Error_AdbOfflineThreshold`
- `Error_GameStuckRestart`
- `Error_GameStuckThreshold`
- `Error_LlmAnalysis`
- `Error_LlmApiBase`
- `Error_LlmApiKey`
- `Error_LlmModel`
- `Error_RestartOperationTimeout`
- `Error_RestartOperationTimeoutEnable`
- `Error_SaveErrorCount`
- `Error_StrictRestart`
- `Error_WatchdogEnable`
- `Error_WatchdogTaskEnable`
- `Error_WatchdogTaskTimeout`
- `Exercise_DelayUntilHoursBeforeNextUpdate`
- `FleetInfo_Record`
- `FleetInfo_Result`
...
- `Gem_Record`
- `Gem_Value`
- `GemsFarming_AllowHighFlagshipLevel`
- `GemsFarming_AllowLowVanguardLevel`
- `GemsFarming_CommonCVFilter`
- `GemsFarming_CommonDDFilter`
- `GemsFarming_DelayTaskIFNoFlagship`
- `GemsFarming_EquipmentCode`
- `GemsFarming_HighValueCommissionFilterCount`
- `GemsFarming_HighValueCommissionReserve`
- `GemsFarming_IgnoreEmotionWarning`
- `GemsFarming_UseEmotionFirst`
- `GemsFarming_VanguardLevelMax`
- `GemsFarming_VanguardLevelMin`
- `GeneralShop_Enable`
- `GeneralShop_OverflowCoins`
- `GuildCoin_Color`
- `GuildCoin_Record`
- `GuildCoin_Value`
- `GuildShop_Enable`
...
- `IslandAirDrop_LastSteal`
- `IslandAirDrop_VisitOtherIsland`
- `IslandBusinessShop1_BoostReplaceFilter`
- `IslandBusinessShop1_Char1`
- `IslandBusinessShop1_Char2`
- `IslandBusinessShop1_Product1`
- `IslandBusinessShop1_Product2`
- `IslandBusinessShop1_Product3`
- `IslandBusinessShop1_Product4`
- `IslandBusinessShop1_Product5`
- `IslandBusinessShop1_SeasonalFallback`
- `IslandBusinessShop2_BoostReplaceFilter`
- `IslandBusinessShop2_Char1`
- `IslandBusinessShop2_Char2`
- `IslandBusinessShop2_Product1`
- `IslandBusinessShop2_Product2`
- `IslandBusinessShop2_Product3`
- `IslandBusinessShop2_Product4`
- `IslandBusinessShop2_Product5`
- `IslandBusinessShop2_SeasonalFallback`
- `IslandBusinessShop3_BoostReplaceFilter`
- `IslandBusinessShop3_Char1`
- `IslandBusinessShop3_Char2`
- `IslandBusinessShop3_Product1`
- `IslandBusinessShop3_Product2`
- `IslandBusinessShop3_Product3`
- `IslandBusinessShop3_Product4`
- `IslandBusinessShop3_Product5`
- `IslandBusinessShop4_BoostReplaceFilter`
- `IslandBusinessShop4_Char1`
- `IslandBusinessShop4_Char2`
- `IslandBusinessShop4_Product1`
- `IslandBusinessShop4_Product2`
- `IslandBusinessShop4_Product3`
- `IslandBusinessShop4_Product4`
- `IslandBusinessShop4_Product5`
- `IslandBusinessShop5_BoostReplaceFilter`
- `IslandBusinessShop5_Char1`
- `IslandBusinessShop5_Char2`
- `IslandBusinessShop5_Product1`
- `IslandBusinessShop5_Product2`
- `IslandBusinessShop5_Product3`
- `IslandBusinessShop5_Product4`
- `IslandBusinessShop5_Product5`
- `IslandBusiness_Batch1Shops`
- `IslandBusiness_Batch2Shops`
- `IslandBusiness_BatchEnabled`
- `IslandBusiness_SeasonalReplaceEnabled`
- `IslandBusiness_SeasonalThreshold`
- `IslandCargoPreparation_Blacklist`
- `IslandDailyGather_WorkerFilter`
- `IslandDailyInteract_WeeklyPhoto`
- `IslandDailyOrder_RejectCount`
- `IslandDailyOrder_RejectFilter`
- `IslandDailyOrder_UrgentDetectRefreshTime`
- `IslandFarm_MinFarm`
- `IslandFarm_PlantPotatoes`
- `IslandFarm_Positions`
- `IslandFarm_WorkerFilter`
- `IslandFishery_MinBass`
- `IslandFishery_MinCrab`
- `IslandFishery_MinCrayfish`
- `IslandFishery_MinSeaCucumber`
- `IslandFishery_MinShell`
- `IslandFishery_MinShrimp`
- `IslandFishery_MinSquid`
- `IslandFishery_MinYellowfinTuna`
- `IslandFishery_PlantYellowfinTuna`
- `IslandFishery_Positions`
- `IslandFishery_RancherFilter`
- `IslandForest_CutElegant`
- `IslandForest_MinElegant`
- `IslandForest_MinPractical`
- `IslandForest_MinSelected`
- `IslandForest_Positions`
- `IslandForest_WorkerFilter`
- `IslandGrillNextTask_AwayCook`
- `IslandGrill_ChefFilter`
- `IslandGrill_Meal1`
- `IslandGrill_Meal2`
- `IslandGrill_Meal3`
- `IslandGrill_Meal4`
...
- `IslandGrill_Meal7`
- `IslandGrill_Meal8`
- `IslandGrill_MealNumber1`
- `IslandGrill_MealNumber2`
- `IslandGrill_MealNumber3`
- `IslandGrill_MealNumber4`
- `IslandGrill_MealNumber5`
- `IslandGrill_MealNumber6`
- `IslandGrill_MealNumber7`
- `IslandGrill_MealNumber8`
- `IslandGrill_PostNumber`
- `IslandJuuCoffeeNextTask_AwayCook`
- `IslandJuuCoffee_ChefFilter`
- `IslandJuuCoffee_Friedrich`
- `IslandJuuCoffee_Meal1`
- `IslandJuuCoffee_Meal2`
- `IslandJuuCoffee_Meal3`
- `IslandJuuCoffee_Meal4`
- `IslandJuuCoffee_Meal5`
- `IslandJuuCoffee_Meal6`
- `IslandJuuCoffee_Meal7`
- `IslandJuuCoffee_Meal8`
- `IslandJuuCoffee_MealNumber1`
- `IslandJuuCoffee_MealNumber2`
- `IslandJuuCoffee_MealNumber3`
- `IslandJuuCoffee_MealNumber4`
- `IslandJuuCoffee_MealNumber5`
- `IslandJuuCoffee_MealNumber6`
- `IslandJuuCoffee_MealNumber7`
- `IslandJuuCoffee_MealNumber8`
- `IslandJuuCoffee_PostNumber`
- `IslandJuuEateryNextTask_AwayCook`
- `IslandJuuEatery_ChefFilter`
- `IslandJuuEatery_Meal1`
- `IslandJuuEatery_Meal2`
- `IslandJuuEatery_Meal3`
- `IslandJuuEatery_Meal4`
- `IslandJuuEatery_Meal5`
- `IslandJuuEatery_Meal6`
- `IslandJuuEatery_Meal7`
- `IslandJuuEatery_Meal8`
- `IslandJuuEatery_MealNumber1`
- `IslandJuuEatery_MealNumber2`
- `IslandJuuEatery_MealNumber3`
- `IslandJuuEatery_MealNumber4`
- `IslandJuuEatery_MealNumber5`
- `IslandJuuEatery_MealNumber6`
- `IslandJuuEatery_MealNumber7`
- `IslandJuuEatery_MealNumber8`
- `IslandJuuEatery_PostNumber`
- `IslandMine_MinAluminium`
- `IslandMine_MinCopper`
- `IslandMine_MinIron`
- `IslandMine_MinSilver`
- `IslandMine_MinSulphur`
- `IslandMine_MineSilver`
- `IslandMine_Positions`
- `IslandMine_WorkerFilter`
- `IslandNursery_IgnorePineapple`
- `IslandNursery_MinNursery`
- `IslandNursery_PlantLavender`
- `IslandNursery_Positions`
- `IslandNursery_WorkerFilter`
- `IslandOrchard_AmagiChanRubber`
- `IslandOrchard_IgnoreAvocado`
- `IslandOrchard_MinOrchard`
- `IslandOrchard_PlantRubber`
- `IslandOrchard_Positions`
- `IslandOrchard_WorkerFilter`
- `IslandPearlSell_BuyNextRun`
- `IslandPearlSell_BuyPrice`
- `IslandPearlSell_DailyPriceRefresh`
- `IslandPearlSell_NextPearlTradeTime`
- `IslandPearlSell_SellPrice`
- `IslandPlan_Season`
- `IslandRancher_ChickenFilter`
- `IslandRancher_Milk`
- `IslandRancher_MinChicken`
- `IslandRancher_MinPork`
- `IslandRancher_PigFilter`
- `IslandRancher_RancherFilter`
- `IslandRancher_Wool`
- `IslandRancher_WoolWorkerFilter`
- `IslandRestaurantNextTask_AwayCook`
- `IslandRestaurant_ChefFilter`
- `IslandRestaurant_DoubleBambooShoots`
- `IslandRestaurant_Meal1`
- `IslandRestaurant_Meal2`
- `IslandRestaurant_Meal3`
- `IslandRestaurant_Meal4`
- `IslandRestaurant_Meal5`
- `IslandRestaurant_Meal6`
- `IslandRestaurant_Meal7`
- `IslandRestaurant_Meal8`
- `IslandRestaurant_MealNumber1`
- `IslandRestaurant_MealNumber2`
- `IslandRestaurant_MealNumber3`
- `IslandRestaurant_MealNumber4`
- `IslandRestaurant_MealNumber5`
- `IslandRestaurant_MealNumber6`
- `IslandRestaurant_MealNumber7`
- `IslandRestaurant_MealNumber8`
- `IslandRestaurant_PostNumber`
- `IslandTeahouseNextTask_AwayCook`
- `IslandTeahouse_ChefFilter`
- `IslandTeahouse_Meal1`
- `IslandTeahouse_Meal2`
- `IslandTeahouse_Meal3`
- `IslandTeahouse_Meal4`
- `IslandTeahouse_Meal5`
- `IslandTeahouse_Meal6`
- `IslandTeahouse_Meal7`
- `IslandTeahouse_Meal8`
- `IslandTeahouse_MealNumber1`
- `IslandTeahouse_MealNumber2`
- `IslandTeahouse_MealNumber3`
- `IslandTeahouse_MealNumber4`
- `IslandTeahouse_MealNumber5`
- `IslandTeahouse_MealNumber6`
- `IslandTeahouse_MealNumber7`
- `IslandTeahouse_MealNumber8`
- `IslandTeahouse_PostNumber`
- `IslandTeahouse_Seasonal`
- `Log_LogBackUpMethod`
- `Log_LogKeepCount`
- `Log_ZipMethod`
- `MaritimeEscort_Enable`
- `MedalShop2_Enable`
- `Medal_Color`
- `Medal_Record`
- `Medal_Value`
...
- `Oil_Record`
- `Oil_Value`
- `OperationHandover_AutoSupplementTime`
- `OperationHandover_CommissionEnd`
- `OperationHandover_ConsumeAllBook`
- `OperationHandover_ConsumeAllBookRecord`
- `OperationHandover_ConsumeAllBookTime`
- `OperationHandover_ConsumeAllBookWeekday`
- `OperationHandover_Count`
- `OperationHandover_MaintainOverride`
- `OperationHandover_OilLimit`
- `OperationHandover_UseHandoverBook`
- `OpsiAshBeacon_AutoCollectShip`
- `OpsiCheckLeveling_CheckInterval`
- `OpsiCheckLeveling_CustomCheckPositions`
- `OpsiCheckLeveling_DelayAfterFull`
- `OpsiCheckLeveling_EnableCustomCheck`
- `OpsiCheckLeveling_LastRun`
- `OpsiCheckLeveling_TargetLevel`
- `OpsiDaily_CollectTargetReward`
- `OpsiDaily_KeepMissionZone`
- `OpsiDaily_MissionZones`
- `OpsiDaily_SkipSirenResearchMission`
- `OpsiExplore_AllowHazard1Leveling`
- `OpsiExplore_ExploreProgress`
- `OpsiFleetAutoChange_CooldownHours`
- `OpsiFleetAutoChange_Enable`
- `OpsiFleetAutoChange_LastRun`
- `OpsiGeneral_AutoSearchTimeLimit`
- `OpsiGeneral_DebugClipRetentionDays`
- `OpsiGeneral_IndependentPush`
- `OpsiGeneral_LauncherPush`
- `OpsiGeneral_NotifyOpsiMail`
- `OpsiGeneral_OpsiOnePushConfig`
- `OpsiGeneral_RepairPackThreshold`
- `OpsiGeneral_RepairPackThresholdHazard1`
- `OpsiGeneral_UseRepairPack`
- `OpsiHazard1Leveling_Cl1Filter`
- `OpsiHazard1Leveling_DebugClip`
- `OpsiHazard1Leveling_ExecuteFixedPatrolScan`
- `OpsiHazard1Leveling_MinimumActionPointReserve`
- `OpsiHazard1Leveling_OperationCoinsPreserve`
- `OpsiHazard1Leveling_RecordNonCL1AP`
- `OpsiHazard1Leveling_RecordSeaMiles`
- `OpsiHazard1Leveling_SkipHpCheck`
- `OpsiMeowfficerFarming_DebugClip`
- `OpsiMeowfficerFarming_ExecuteFixedPatrolScan`
- `OpsiMeowfficerFarming_StayInZone`
- `OpsiObscure_SkipHazard2Obscure`
- `OpsiPreventActionPointOverflow_ActionPointLowerbound`
- `OpsiPreventActionPointOverflow_ActionPointUpperbound`
- `OpsiPreventActionPointOverflow_Task`
- `OpsiScheduling_ActionPointPreserve`
- `OpsiScheduling_EnableAbyssal`
- `OpsiScheduling_EnableMeowfficerFarming`
- `OpsiScheduling_EnableObscure`
- `OpsiScheduling_EnableStronghold`
- `OpsiScheduling_MonthEndActionPointCleanupDays`
- `OpsiScheduling_MonthEndActionPointCleanupEnable`
- `OpsiScheduling_MonthEndActionPointPreserve`
- `OpsiScheduling_MonthEndShopPurchase`
- `OpsiScheduling_ObscureAbyssalCheckDelayDays`
- `OpsiScheduling_OperationCoinsPreserve`
- `OpsiScheduling_OperationCoinsReturnThreshold`
- `OpsiScheduling_TaskPriority`
- `OpsiScheduling_UseSmartSchedulingOperationCoinsPreserve`
- `OpsiShop_DisableBeforeDate`
- `OpsiSimulatorParameters_AkashiProbability`
- `OpsiSimulatorParameters_BuyAp`
- `OpsiSimulatorParameters_Cl1Coin`
- `OpsiSimulatorParameters_Cl1Time`
- `OpsiSimulatorParameters_CrossWeek`
- `OpsiSimulatorParameters_Deterministic`
- `OpsiSimulatorParameters_Draw`
- `OpsiSimulatorParameters_InitialAp`
- `OpsiSimulatorParameters_InitialCoin`
- `OpsiSimulatorParameters_Meow3Coin`
- `OpsiSimulatorParameters_Meow3Time`
- `OpsiSimulatorParameters_Meow5Coin`
- `OpsiSimulatorParameters_Meow5Time`
- `OpsiSimulatorParameters_MeowHazardLevel`
- `OpsiSimulatorParameters_Samples`
- `OpsiSimulatorParameters_TimeUseRatio`
- `OpsiSimulatorParameters_TotalTime`
- `OpsiSirenBug_SirenResearch_Enable`
- `OpsiSirenBug_Siren_Fleet`
- `OpsiSirenBug_Siren_Mode`
- `OpsiStronghold_HasStronghold`
- `OpsiStronghold_SubmarineEveryCombat`
- `OpsiTarget_LastRun`
- `OpsiTarget_TargetFarming`
- `OpsiTarget_TargetZone`
- `Optimization_CloseEmulatorDuringLongWait`
- `Optimization_OcrBackend`
- `Optimization_OcrDevice`
- `Optimization_OcrModelVersionChinese`
- `Optimization_OcrModelVersionEnglish`
- `Optimization_OcrModelVersionJapanese`
- `Optimization_OcrModelVersionTraditionalChinese`
- `Optimization_OcrWindowsMlVendorEp`
- `Optimization_WarmupEnable`
- `Optimization_WarmupMinutes`
- `Optimization_WhenSchedulerStopped`
- `Pt_Color`
- `Pt_Record`
- `Pt_Value`
- `PublicEmotion_Enable`
- `PublicEmotion_FleetControl`
- `PublicEmotion_FleetOath`
- `PublicEmotion_FleetOnsen`
- `PublicEmotion_FleetRecord`
- `PublicEmotion_FleetRecover`
- `PublicEmotion_FleetValue`
- `PublicEmotion_Tasks`
- `PurpleCoin_Color`
- `PurpleCoin_Record`
- `PurpleCoin_Value`
- `Research_AllowGenreT`
- `Research_RemainingCommissions`
- `Restart_ClearCache`
- `Restart_LoginWaitTimeout`
- `Restart_MoveChannelFloat`
- `Restart_RandomDelay`
- `Scheduler_PushNotification`
- `Scheduler_Sensitive`
- `Secretary_BackupEnable`
- `Secretary_CheckInterval`
- `Secretary_CustomFilter`
- `Secretary_FavouriteOnly`
- `Secretary_LowFavorabilityPriority`
- `Secretary_Notify`
- `Secretary_OnePushConfig`
- `StopCondition_CoinLimit`
- `StopCondition_OilLimitHardFloor`
- `Submarine_AdvancedConfig`
- `Tactical_SkillAutoSwitch`
- `WarArchives_AutoClear`
- `WarArchives_AutoClearProgress`
- `WarArchives_AutoClearTarget`
- `WarArchives_AutoSelectEvent`
- `WarArchives_DailyRunCount`
- `WarArchives_DailyRunCountLimit`
- `WarArchives_DailyRunCountRecord`
- `WarArchives_DailyRunCountRemain`
- `WoodProcessing_Positions`
- `YellowCoin_Color`
- `YellowCoin_Record`
- `YellowCoin_Value`
- `YukikazeTaskManager_TaskPriorityAdjustment`

### Removed configuration keys

- `EquipmentCode_Config`
- `EquipmentCode_ExportToConfig`
- `IslandFreebie_Share`
- `IslandOrder_StuckSeasonOrderId`
- `IslandProductionPlanner_DailyBufferSafetyMargin`
- `IslandProductionPlanner_DailyProfitLowerLimit`
- `IslandProductionPlanner_FieldsEfficiency`
- `IslandProductionPlanner_NurseryEfficiency`
- `IslandProductionPlanner_OrchardEfficiency`
- `IslandProductionPlanner_RescanIslandTechnology`
...
- `IslandProduction_SkipBufferSurplus`
- `IslandRestaurant_BearGrade`
- `IslandRestaurant_BearMenu`
- `IslandRestaurant_BearWaitress1`
- `IslandRestaurant_BearWaitress2`
- `IslandRestaurant_CafeGrade`
- `IslandRestaurant_CafeMenu`
- `IslandRestaurant_CafeWaitress1`
- `IslandRestaurant_CafeWaitress2`
- `IslandRestaurant_EateryGrade`
- `IslandRestaurant_EateryMenu`
- `IslandRestaurant_EateryWaitress1`
- `IslandRestaurant_EateryWaitress2`
- `IslandRestaurant_GrillGrade`
- `IslandRestaurant_GrillMenu`
- `IslandRestaurant_GrillWaitress1`
- `IslandRestaurant_GrillWaitress2`
- `IslandRestaurant_KoiGrade`
- `IslandRestaurant_KoiMenu`
- `IslandRestaurant_KoiWaitress1`
- `IslandRestaurant_KoiWaitress2`
- `IslandSeasonTask_TaskTarget`
- `Meowfficer_OverflowCoins`

### Changed defaults

- `DropRecord_OpsiRecord`: ALAS `'do_not'` → AzurPilot `'upload'`
- `GemsFarming_ChangeFlagship`: ALAS `'ship'` → AzurPilot `'ship_equip'`
- `GemsFarming_ChangeVanguard`: ALAS `'ship'` → AzurPilot `'ship_equip'`
- `GemsFarming_CommissionLimit`: ALAS `True` → AzurPilot `False`
- `GeneralShop_ConsumeCoins`: ALAS `False` → AzurPilot `0`
- `OpsiGeneral_AkashiShopFilter`: ALAS `'ActionPoint > PurpleCoins'` → AzurPilot `'ActionPoint'`
- `Reward_CollectWeeklyMission`: ALAS `True` → AzurPilot `False`
